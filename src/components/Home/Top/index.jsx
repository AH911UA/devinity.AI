...
import slideMobile2 from "../../../images/blog/items/blog-item-6-2.png";
import slideMobile3 from "../../../images/blog/items/blog-item-2-4.png";
import slideMobile4 from "../../../images/home-page/slide-4.png";

const _slidesMobile = [slideMobile1, slideMobile2, slideMobile3, slideMobile4];
...
const Top = () => {
  ...
  useEffect(() => {
    if (isMobileSmall) {
      ...
      setSlides(_slides.map((slide, i) => ({...slide, img: _slidesMobile[i]})));
    } else {
      setSlides(_slides)
    }
